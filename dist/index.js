...
function getCallerInfo() {
    ...
    for (const line of stack || []) {
        ...
        if (match) {
            ...
            const funcName = ((_b = match[1]) === null || _b === void 0 ? void 0 : _b.split(" ")[0]) || "anonymous";
            return {
...
function logWithMeta(message, meta = {}) {
    ...
    const logEntry = Object.assign(Object.assign({ timestamp,
        level,
        file, function: func, message }, (meta.requestId && { requestId: meta.requestId })), (meta.extra || {}));
